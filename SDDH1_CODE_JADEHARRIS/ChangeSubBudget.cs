...
{
    public partial class frm_changeSubBudget : Form
    {

        private frm_subjectOverview subjectOverviewForm = null; //Create a form reference so that functions from the Subject Overview can be called
        public frm_changeSubBudget(Form hubCallingForm)
        {
        ...
        private void GetSubjectSpent()
        {
            ...
            subAmountSpent = 0; //Reset for each calculation
